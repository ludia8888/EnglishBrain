...
public struct AttemptSubmission: Codable, JSONEncodable, Hashable {
    ...
    public init(attemptId: String, itemId: String, startedAt: Date, completedAt: Date, placements: [Placement], verdict: Verdict, timeSpentMs: Int, hintsUsed: Int, comboCount: Int, errors: [AttemptError]? = nil, retryNumber: Int? = nil, firstTryCorrect: Bool? = nil) {
