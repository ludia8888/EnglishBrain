...
public struct CheckpointSubmission: Codable, JSONEncodable, Hashable {
    ...
    public init(checkpointId: String, phaseId: String, reachedAt: Date, accuracy: Double, comboMax: Int, hintsUsed: Int, durationSeconds: Int, brainTokensEarned: Int? = nil, freezeConsumed: Bool? = nil) {
